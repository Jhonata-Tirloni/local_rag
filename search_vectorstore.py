...
def rag_question(question_prompt: str, vector_results: list[Document]) -> None:
    ...
    Then sends the data to a LLM model and returns the answerd based on those two parameters.

    :param: question_prompt: str = The question to be answered by the LLM model
    :param: vector_results: Document = The result of a vectorstore similary search
